...
This is a study. Not implemented and not final either.
One problem is the limited ability to recover the original ctrlbits
and the brittleness of the GTOS test.
...
[def _OScall=*                                 { call with \OScall!       }
  ...
  [ $5447 _vLR= $8000 deek _vLR^ if=0          { test $8000 for "GT"      }
    ...
    %2 $8004! %2=                              { call $8004 save result   }
   else
